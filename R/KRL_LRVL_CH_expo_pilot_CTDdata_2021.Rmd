...
#getwd()
#no data in cast1
CTDfilesCast1 <- read_csv(here::here("raw_data", "CTDcastData", "2021.06.23", "CC1827005_20210623_070521.csv"))

cast_file_name <- "CC1827005_20210623_070614.csv"

#data!
CTDfilesCast2 <- read_csv(here::here("raw_data", "CTDcastData", "2021.06.23", cast_file_name))
...
serial <- word(cast_file_name_x, sep = "_")
date <- word(cast_file_name_x, 2, sep = "_")
time <- word(cast_file_name_x, 3, sep = "_")
